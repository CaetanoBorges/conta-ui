...
<div class="cabecalho">
    ...
    <img src="http://cdn.binga.ao/conta/icones/apps.png" class="botao-img" tipo="rv-aciona-modal" qual="#modal-servicos">
</div>
                    ...
                    <div class="div-centro">
                        <?php
                            foreach($servicos as $servico){
                                ...
                                ?>
                                    <a href="<?php echo $servico['link']."?ftpadbc=".$TOKEN ?>" target="_blink" class="topo-servicos">
